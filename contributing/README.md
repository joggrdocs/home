...
Welcome to the Joggr Code contributing docs. This directory contains standards, templates, and guides for working in this codebase.
...
- [Developing a Feature](./guides/developing-a-feature.md) -- Branch, code, test, commit, PR, merge
